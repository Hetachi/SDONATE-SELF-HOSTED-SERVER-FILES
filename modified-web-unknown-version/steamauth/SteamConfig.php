...
$steamauth['apikey'] = $steamapi; // Your Steam WebAPI-Key found at http://steamcommunity.com/dev/apikey
$steamauth['domainname'] = $_SERVER['HTTP_HOST']; // The main URL of your website displayed in the login page
...
$steamauth['loginpage'] = "steamlogin.php"; // Page to redirect to after a successfull login (from the directory the SteamAuth-folder is located in) - NO slash at the beginning!
